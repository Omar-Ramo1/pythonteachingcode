...
class Calculator(Frame):
    ...
    def create_widgets(self):
        ...
        self.cos_btn = Button(self, text="cos", width=9, height=3, command=lambda: self.add_chr('cos'))
        self.cos_btn.grid(row=2, column=6)

        self.tan_btn = Button(self, text="tan", width=9, height=3, command=lambda: self.add_chr('tan'))
        ...
        self.one_bttn = Button(self, text="Omar", width=9, height=3, command=lambda: self.add_chr('Idris'))
